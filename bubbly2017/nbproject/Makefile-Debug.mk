...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V5S/Debug/bubbly2017.exe

dist/V5S/Debug/bubbly2017.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V5S/Debug
	arm-brcm-linux-gnueabi-g++ -L . "-L${SDKV5SLIB}" "-L${SDKV5SLIBN}" -o dist/V5S/Debug/bubbly2017  ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} dist/V5S/Debug/bubbly2017.exe
